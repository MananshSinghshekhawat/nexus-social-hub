    ...
    return (
        <div className="h-[calc(100vh-2rem)] flex flex-col items-center justify-center relative">
            ...
            >
                ...
                <h1 className="text-3xl font-bold font-display tracking-tight mb-2">Reels</h1>
                <p className="text-muted-foreground text-lg mb-6">Coming Soon</p>
                <p className="text-sm text-muted-foreground/80">We are currently building an amazing Reels experience for you. Stay tuned!</p>
            </motion.div>
        </div>
    );
};
